            ...
            <div className="medals__container">
              <div className="medals__container__column">
                ...
                <div className="base base__1">
                  <img className="medal__img medal__1__img" src="/img/medal_silver.png" alt="Silver Medals" />
                </div>
              </div>
              ...
              <div className="medals__container__column">
                ...
                <div className="base base__2">
                  <img className="medal__img medal__2__img" src="/img/medal_gold.png" alt="Gold Medals" />
                </div>
              </div>
              ...
              <div className="medals__container__column">
                ...
                <div className="base base__3">
                  <img className="medal__img medal__3__img" src="/img/medal_bronze.png" alt="Bronze Medals" />
                </div>
              </div>
            </div>
          </div>
